...
export const STRINGS = {
    ...
    // --- GTS / Wonder Trade ---
    "gts.received":         { en: "You received §l{label}§r!", vi: "Bạn nhận được §l{label}§r!" },
    "gts.noeligible":       { en: "No eligible Pokemon in your team.", vi: "Không có Pokemon hợp lệ trong đội." },
    "gts.moved":            { en: "That Pokemon just moved - try again.", vi: "Pokemon vừa bị di chuyển - thử lại." },
    "gts.wonder.title":     { en: "WONDER TRADE", vi: "WONDER TRADE" },
    "gts.wonder.note":      { en: "Send one Pokemon, get a random one\nfrom another trainer. No take-backs!\n§7Waiting in pool: {n}{mine}§r", vi: "Gửi một Pokemon, nhận ngẫu nhiên\ntừ người khác. Không đổi lại!\n§7Đang chờ trong hồ: {n}{mine}§r" },
    "gts.wonder.yours":     { en: " (yours: {m})", vi: " (của bạn: {m})" },
    "gts.wonder.confirm":   { en: "§lWonder Trade§r\n\nSend away §l{label}§r?\nYou can't choose what comes back.", vi: "§lWonder Trade§r\n\nGửi đi §l{label}§r?\nBạn không chọn được thứ nhận lại." },
    "gts.wonder.matched":   { en: "Matched with §l{name}§r! You got §l{label}§r!", vi: "Ghép với §l{name}§r! Bạn nhận §l{label}§r!" },
    "gts.wonder.matched.pc":{ en: "Matched! Your Pokemon arrives once you have space.", vi: "Đã ghép! Pokemon sẽ tới khi bạn có chỗ." },
    "gts.wonder.poolfull":  { en: "Pool is full right now - try later.", vi: "Hồ đang đầy - thử lại sau." },
    "gts.wonder.deposited": { en: "§l{label}§r is in the pool. You'll get a Pokemon when someone else deposits!", vi: "§l{label}§r đã vào hồ. Bạn sẽ nhận Pokemon khi có người khác gửi!" },
    "gts.shiny":            { en: "shiny", vi: "shiny" },
    "gts.list.title":       { en: "LIST ON GTS", vi: "ĐĂNG LÊN GTS" },
    "gts.list.note":        { en: "Pick the Pokemon you offer.", vi: "Chọn Pokemon bạn muốn đưa ra." },
    "gts.want.title":       { en: "GTS - what do you want?", vi: "GTS - bạn muốn gì?" },
    "gts.want.species":     { en: "Species name (e.g. Gengar):", vi: "Tên loài (vd Gengar):" },
    "gts.want.species.ph":  { en: "type a name...", vi: "gõ một tên..." },
    "gts.want.minlvl":      { en: "Minimum level", vi: "Cấp tối thiểu" },
    "gts.want.shinyonly":   { en: "Shiny only", vi: "Chỉ shiny" },
    "gts.unknownspecies":   { en: "Unknown species name: {name}", vi: "Tên loài không rõ: {name}" },
    "gts.max":              { en: "Max 3 active listings per player.", vi: "Tối đa 3 tin đăng mỗi người." },
    "gts.full":             { en: "GTS is full - try later.", vi: "GTS đầy - thử lại sau." },
    "gts.list.confirm":     { en: "§lGTS Listing§r\n\nOffer: §l{offer}§r\nWant: §l{want}§r\n\nList it?", vi: "§lTin GTS§r\n\nĐưa ra: §l{offer}§r\nMuốn: §l{want}§r\n\nĐăng?" },
    "gts.listed":           { en: "Listed! You'll receive the trade even while offline.", vi: "Đã đăng! Bạn nhận trao đổi kể cả khi offline." },
    "gts.nolistings":       { en: "No listings from other trainers right now.", vi: "Hiện chưa có tin từ người khác." },
    "gts.browse.body":      { en: "§lGTS - {n} listings§r\nTap one you can fulfill:", vi: "§lGTS - {n} tin§r\nBấm tin bạn có thể đáp ứng:" },
    "gts.browse.btn":       { en: "{label}\n§7wants: {want} §8({name})", vi: "{label}\n§7muốn: {want} §8({name})" },
    "gts.fulfill.title":    { en: "FULFILL LISTING", vi: "ĐÁP ỨNG TIN" },
    "gts.fulfill.note":     { en: "They want: §l{want}§r\nPick a matching Pokemon to give:", vi: "Họ muốn: §l{want}§r\nChọn Pokemon khớp để đưa:" },
    "gts.trade.confirm":    { en: "§lGTS Trade§r\n\nGive: §l{give}§r\nGet:  §l{get}§r\n\nConfirm?", vi: "§lGiao dịch GTS§r\n\nĐưa: §l{give}§r\nNhận: §l{get}§r\n\nXác nhận?" },
    "gts.taken":            { en: "That listing was just taken.", vi: "Tin đó vừa bị nhận mất." },
    "gts.nomatch":          { en: "It no longer matches the request.", vi: "Không còn khớp yêu cầu nữa." },
    "gts.trade.done":       { en: "Trade done! You got §l{label}§r from {name}!", vi: "Xong! Bạn nhận §l{label}§r từ {name}!" },
    "gts.trade.donepc":     { en: "Trade done! It arrives once you have space.", vi: "Xong! Sẽ tới khi bạn có chỗ." },
    "gts.nomine":           { en: "You have no active listings.", vi: "Bạn chưa có tin đăng nào." },
    "gts.mine.body":        { en: "§lMY LISTINGS§r\nTap to cancel and take back:", vi: "§lTIN CỦA TÔI§r\nBấm để huỷ và lấy lại:" },
    "gts.mine.btn":         { en: "{label}\n§7wants: {want}", vi: "{label}\n§7muốn: {want}" },
    "gts.mine.completed":   { en: "That listing already completed - check your team/PC!", vi: "Tin đó đã hoàn tất - kiểm tra đội/PC!" },
    "gts.mine.cancelled":   { en: "Listing cancelled, §l{label}§r returned.", vi: "Đã huỷ tin, §l{label}§r đã trả lại." },
    "gts.machine.body":     { en: "§lTRADE MACHINE+§r\n§7(tap without sneaking for SERP's own trade)§r{owed}", vi: "§lTRADE MACHINE+§r\n§7(bấm không cúi để dùng trade gốc của SERP)§r{owed}" },
    "gts.machine.owed":     { en: "\n§a{n} Pokemon waiting for you!§r", vi: "\n§a{n} Pokemon đang chờ bạn!§r" },
    "gts.machine.wonder":   { en: "Wonder Trade\n§8Send one, get a surprise", vi: "Wonder Trade\n§8Gửi một, nhận bất ngờ" },
    "gts.machine.browse":   { en: "GTS - Browse listings\n§8Fulfill someone's request", vi: "GTS - Xem tin\n§8Đáp ứng yêu cầu của người khác" },
    "gts.machine.list":     { en: "GTS - List a Pokemon\n§8Set what you want back", vi: "GTS - Đăng Pokemon\n§8Đặt thứ muốn nhận lại" },
    "gts.machine.mine":     { en: "GTS - My listings\n§8Cancel / take back", vi: "GTS - Tin của tôi\n§8Huỷ / lấy lại" },
    "gts.delivery":         { en: "Delivery: §l{label}§r arrived from a trade!", vi: "Giao hàng: §l{label}§r đã tới từ một giao dịch!" },
};
